...
# Импортирует вершины, полигоны, текстурные координаты, материалы, изображения.
...
def parseMaterialBlock(s, material_names):
    ...
    for name, texture in textures:
        try:
            if bpy.data.objects[-1].material_slots[name].material.texture_slots[0].name:
                pass
        except:
