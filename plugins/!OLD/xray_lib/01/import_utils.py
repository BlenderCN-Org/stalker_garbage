...
def create_materials(mesh, materials):
    for i in materials:
...
def crete_mesh(vertices, triangles=(), materials=None, material_indices=None, uvs=None, image=None):
    object, mesh = create_object()
    mesh.from_pydata(vertices, (), triangles)
    if materials:
        create_materials(mesh, materials)
